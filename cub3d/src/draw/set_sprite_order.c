...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/18 07:21:15 by olugash           #+#    #+#             */
/*   Updated: 2022/11/18 07:23:05 by olugash          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_distance(t_game *game)
{
	...
	while (++i < game->map->sprite_count)
	{
		...
		game->sprite[i]->distance = (game->player.pos.x - coord->x)
			* (game->player.pos.x - coord->x) + (game->player.pos.y - coord->y)
